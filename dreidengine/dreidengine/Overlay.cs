...
namespace dreidengine
{
    ...
    public class Overlay : DrawableGameComponent
    {
        ...
        private void DrawOverlay()
        {
            ...
            spriteBatch.Draw(overlayCrosshair, new Microsoft.Xna.Framework.Rectangle(((Game1)Game).Graphics.PreferredBackBufferWidth / 2 - overlayCrosshair.Width / 2, ((Game1)Game).Graphics.PreferredBackBufferHeight / 2 - overlayCrosshair.Height / 2, 35, 35), Color.White);
        }
